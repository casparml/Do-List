...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function createTodoItem(todo, todoIndex) {
        ...
        todoLI.innerHTML = `
        <div class="drag-handle mt-2 me-1">
        ...
        <label class="custom-checkbox ms-1" for="${todoId}">
        ...
        <button class="editButton btn btn-link me-1 p-0">
        ...
        <button class="delete-button btn btn-link ms-1 p-0">
